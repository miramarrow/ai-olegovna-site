...
const timelineSteps = [
  {
    title: "Диагностика",
    result: "фиксируем задачу, ограничения и главный результат запуска",
  },
  {
    title: "Сценарий",
    result: "собираем пользовательский путь, роли и нужные интеграции",
  },
  {
    title: "Сборка",
    result: "создаем рабочую версию системы, бота, сайта или автоматизации",
  },
  {
    title: "Проверка",
    result: "прогоняем реальные сценарии и убираем слабые места",
  },
  {
    title: "Передача",
    result: "передаем доступы, логику работы и понятный следующий шаг",
  },
];
      ...
      <div className="mx-auto max-w-7xl">
        <div className="mb-10 grid gap-5 md:grid-cols-[0.7fr_1fr] md:items-end">
          ...
          <p className="text-lg leading-relaxed text-muted-foreground">
            Работа идет короткими понятными этапами: сначала разбираем задачу,
            потом собираем рабочий сценарий и передаем систему без лишнего шума.
          </p>
        </div>
