    ...
    <section className="relative flex min-h-[92vh] items-center overflow-hidden px-4 pb-16 pt-28">
      <div className="mx-auto grid max-w-7xl items-center gap-10 lg:grid-cols-[1.05fr_0.95fr]">
        <div className="relative z-10">
          ...
          <h1
            aria-label="Разрабатываем под ключ нейроофисы, AI-агентов, контент-заводы, боты Telegram/MAX, автоматизации и сайты"
            className="max-w-4xl text-4xl font-bold leading-tight text-foreground sm:text-5xl lg:text-6xl"
          >
            <span className="block">Разрабатываем <span className="whitespace-nowrap">под ключ</span></span>
            <span className="mt-3 block min-h-[1.22em] max-w-full" aria-hidden="true">
              <RotatingText
                texts={["нейроофисы", "AI-агентов", "контент-заводы", "боты Telegram/MAX", "автоматизации", "сайты"]}
          ...
          <p className="mt-6 max-w-2xl text-lg leading-relaxed text-muted-foreground sm:text-xl">
            Проектируем и запускаем AI-системы для бизнеса: от сайта и бота для Telegram/MAX до связки CRM, таблиц, заявок, контента и внутренних процессов.
          </p>
