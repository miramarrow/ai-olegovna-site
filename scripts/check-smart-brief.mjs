...
assertIncludes(hero, "whitespace-nowrap\">под ключ</span>", "Hero headline");
assertIncludes(hero, "цифровые решения для бизнеса", "Hero badge");
...
assertIncludes(form, "получу контекст", "ProjectDiscussForm follow-up block");
assertIncludes(form, "вернусь с уточнениями", "ProjectDiscussForm follow-up block");
assertIncludes(form, "предложу формат старта", "ProjectDiscussForm follow-up block");
